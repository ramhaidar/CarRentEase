<x-app-layout>
                                ...
                                @foreach ($mobils as $mobil)
                                    <tr class="border-t border-gray-200 dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-2 flex items-center space-x-4">
                                            ...
                                            <!-- Tombol Hapus -->
                                            <button class="text-red-600 hover:text-red-900" onclick="openModal('{{ $mobil->id }}')">
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                ...
                <div class="mt-5 sm:mt-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" type="button" onclick="closeModal()">
                        {{ __('Batal') }}
                    </button>
                </div>
            </div>
    ...
    <script>
        function openModal(mobilId) {
            document.getElementById('modal').classList.remove('hidden');
            document.getElementById('delete-form').action = '/manajemen/' + mobilId;
        }
